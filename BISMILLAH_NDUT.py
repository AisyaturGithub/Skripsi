...
if  selected == "Deskripsi":
    ...
    st.write("""
        ...
        - Hasil nilai dari evaluasi sistem bersifat objektif
...
if selected == "Levenshtein Distance With Part-Of-Speech (POS) Tagging":
    ...
    if periksa:
        ...
        if user_input == "":
            ...
            data = CRFTagger()
            model_path ='/xampp/htdocs/RISET_DIA/all_indo_man_tag_corpus_model.crf.tagger'
            hasil = result.split()
    ...
    if option == '💯Testing  Tanpa POS Tagging' or option == '':
        ...
        if uploaded_file: 
                ...
                def bersihkan_teks(teks):
                    ...
                    # Fungsi untuk mengoreksi ejaan kata
                def correct_spelling(word, dictionary):
                    # Mengembalikan kata yang benar dari kamus jika ada, jika tidak, mengembalikan kata asli
        ...
        # Concatenating along columns (axis=1)
            ...
            # POS Tagging
            tagger.set_model_file('/xampp/htdocs/RISET_DIA/all_indo_man_tag_corpus_model.crf.tagger')
